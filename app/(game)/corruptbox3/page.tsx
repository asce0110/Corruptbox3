...
export default function Corruptbox3Page() {
  ...
  return (
    <>
      <Head>
        <title>Corruptbox 3 - Revolutionary Music Creation Game | Create & Mix Music Online</title>
        <meta 
          name="description" 
          content="Create amazing beats and mix unique sounds in Corruptbox 3. Experience the ultimate music creation game with advanced features and intuitive controls. Play free in your browser!"
        />
        <meta 
          property="og:title" 
          content="Corruptbox 3 - Revolutionary Music Creation Game" 
        />
        <meta 
          property="og:description" 
          content="Create amazing beats and mix unique sounds in Corruptbox 3. Experience the ultimate music creation game with advanced features and intuitive controls."
        />
        <meta property="og:url" content="https://corruptbox3.com/corruptbox3" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://corruptbox3.com/corruptbox3" />
      </Head>
