...
const games = [
  {
    title: 'Corruptbox 3',
    description: 'Experience the ultimate music creation game with Corruptbox 3. Create amazing beats and explore new musical possibilities.',
    image: 'https://s.incrediboxsprunkimod.com/public/corruptbox3.webp',
    href: '/corruptbox3',
    features: [
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-[#2EE59D] mb-4">
              Corruptbox 3 Music Creation Games
            </h1>
            <p className="text-xl text-gray-300">
              Experience the Future of Music Creation Gaming - From Corruptbox 3 to Classic Favorites
            </p>
          </div>
